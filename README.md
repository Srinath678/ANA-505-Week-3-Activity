...
nrow(womendataset)
ncol(womendataset)
colnames(womendataset)
lapply(womendataset,class)
...
dataindex <- womendataset$height < 0.71
dataindex
...
ggplot(womendataset, aes(x=height, y=weight)) + 
  geom_point()
